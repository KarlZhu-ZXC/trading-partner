...
class AttentionSourceType(StrEnum):
    ...
    OBSERVATION_REVIEW_DUE = "OBSERVATION_REVIEW_DUE"
...
class AttentionClosureCode(StrEnum):
    ...
    DECISION_REVIEW_SUPERSEDED = "DECISION_REVIEW_SUPERSEDED"
    OBSERVATION_REVIEW_CONFIRMED = "OBSERVATION_REVIEW_CONFIRMED"
    UNLINKED_ACTIVITY_ANNOTATED = "UNLINKED_ACTIVITY_ANNOTATED"
