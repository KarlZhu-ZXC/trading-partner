...
from domain.common.errors import ChallengeReviewAlreadyResolved, ChallengeReviewNotFound
...
class SqlAlchemyChallengeReviewRepository:
    ...
    def _hydrate(session: Session, row: ChallengeReviewRow) -> ChallengeReview:
        ...
        return ChallengeReview(
            ...
            resolution=ChallengeResolution(row.resolution) if row.resolution else None,
